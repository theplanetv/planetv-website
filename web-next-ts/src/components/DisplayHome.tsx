  ...
  return (
    <div className="py-20 mx-auto w-fit flex flex-col gap-y-10">
      ...
      <div className="flex flex-col gap-y-5">
        <h2 className="text-center font-bold text-xl">Welcome to my own website!</h2>

        <p className="text-center">This is a place I document about journey. Try to find thing you interest in here I guess...</p>
      </div>
    </div>
  )
}
