...
function BlogTag(props: ChildProps): JSX.Element {
  ...
  return (
    <div>
      {props.formStatus === FormStatusEnum.INSERT && <InsertComponent />}

      {props.formStatus === FormStatusEnum.UPDATE && <UpdateComponent />}

      {props.formStatus === FormStatusEnum.REMOVE && <RemoveComponent />}
    </div>
  );
}
        ...
        <form onSubmit={handleSubmit}>
          <div className="h-screen">
            ...
            <div className="flex space-between">
              <Button
                onClick={() => props.handleFormStatus(FormStatusEnum.NONE)}
              >
                Close
              </Button>
              <Button
